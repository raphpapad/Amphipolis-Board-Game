 ...
 */
public class Skeleton_upper_bigbody extends SkeletonTile {
	
	public Skeleton_upper_bigbody(int id) {
		super(id);
	}
	 ...
	 * of the upper body parts for the big skeleton.
	 * @return The number of them
	 */
	public int Upper_bigbody_pieces() {
		int body_pieces = 0;
		return 0;
	}
}
