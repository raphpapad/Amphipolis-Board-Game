 ...
 *  creates the operations of the assistant card.
 */
public class Assistant extends CharacterCard {
	 ...
	 */
	public void assistant_characteristics() {
		this.count = 0;
	}
	
    public Assistant(String s,Player p) {
        this.setImage(s);
        this.setPlayer(p);
    }
